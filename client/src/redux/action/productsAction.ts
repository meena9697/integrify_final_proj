...
import { FetchProductsRequest, FetchProductsSuccess, FetchProductsFailure } from "./actionTypes"
...
export const fetchProductsSuccess =(response: Products[]): FetchProductsSuccess=>{
  return{
